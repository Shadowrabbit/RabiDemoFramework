...
namespace Rabi
{
    [CreateAssetMenu(fileName = "UICompConfig", menuName = "Rabi/Create UICompConfig", order = 1)]
    public class UICompConfig : ScriptableObject
    {
...
");
            ...
            {
                sb.Append("\r\n");
                sb.AppendFormat("\t\t[MenuItem(\"GameObject/拉比UI/{0}\", false, 0)]\r\n", item.compName);
            ...
            using (var textWriter = new StreamWriter(
                Path.Combine(Application.dataPath, "Extensions/UI/UIConfig/Editor/Generator/UICompGenerator.cs"), false,
                Encoding.UTF8))
            {
